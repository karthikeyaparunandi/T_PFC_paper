...
python class for T-PFC method on car-like robot.
'''
#!/usr/bin/env python
...
from algorithm_classes.T_PFC import T_PFC
from dynamical_models.quadrotor_dynamics import quadrotor


class T_PFC_quadrotor(T_PFC, quadrotor):
	...
	def __init__(self, n_x, n_u, horizon, initial_state, final_state, control_upper_bound, control_lower_bound, dt):
		...
		T_PFC.__init__(self, n_x, n_u, horizon, initial_state, final_state, control_upper_bound, control_lower_bound)
		quadrotor.__init__(self, params.L, params.l_cr, dt)
